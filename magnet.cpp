...
Magnet::Magnet(float x, float y, color_t color,float r) {
    ...
    for(i=0;i<180;i++)
    {
        ...
        vertex_buffer_data[9*i+3] = r*cos((3.14159*(i+270)/180));
        vertex_buffer_data[9*i+4] = r*sin(3.14159*(i+270)/180);
        vertex_buffer_data[9*i+5] = 0.0f;

        vertex_buffer_data[9*i+6] = r*cos(3.14159*(i+271)/180);
        vertex_buffer_data[9*i+7] = r*sin(3.14159*(i+271)/180);
        vertex_buffer_data[9*i+8] = 0.0f;

   
    }
        // vertex_buffer_data[9*i] = -r-10;
        // vertex_buffer_data[9*i+1] = 0.0f;
        // vertex_buffer_data[9*i+2] = 0.0f;

        // vertex_buffer_data[9*i+3] = -r;
        // vertex_buffer_data[9*i+4] = 0.0f;
        // vertex_buffer_data[9*i+5] = 0.0f;

        // vertex_buffer_data[9*i+6] = -r-10;
        // vertex_buffer_data[9*i+7] = -r-10;
        // vertex_buffer_data[9*i+8] = 0.0f;
        // i++;


        // vertex_buffer_data[9*i] = -r;
        // vertex_buffer_data[9*i+1] = 0.0f;
        // vertex_buffer_data[9*i+2] = 0.0f;

        // vertex_buffer_data[9*i+3] = -r;
        // vertex_buffer_data[9*i+4] = -r-10;
        // vertex_buffer_data[9*i+5] = 0.0f;
